...
const ARCHETYPE_FLAVOR: Record<CharacterArchetype, Record<string, string>> = {
  athlete: {
    forage: " Their physical stamina helped them search vast areas.",
    fish: " Their strength and coordination made the catch look easy.",
    water: " They powered through the difficult trek to the water source.",
    rest: " Their athletic conditioning helped them recover quickly.",
    build: " Their physical prowess made the heavy lifting manageable.",
    explore: " Their endurance allowed them to cover serious ground.",
    craft: " Their hand-eye coordination proved valuable.",
  },
  strategist: {
  ...
  survivalist: {
    forage: " Their wilderness knowledge was invaluable.",
    fish: " Years of outdoor experience showed in their technique.",
    water: " They knew exactly where to look for clean water.",
    rest: " They found the ideal recovery spot instinctively.",
    build: " Their survival training really showed.",
    explore: " They read the environment like a book.",
    craft: " Their bushcraft skills came in handy.",
  },
  diplomat: {
    forage: " They coordinated with others for better results.",
    fish: " They traded tips with fellow castaways to improve their technique.",
    water: " They shared their water source with others, building goodwill.",
    rest: " They rested peacefully, free from social anxiety.",
    build: " They collaborated effectively with others.",
    explore: " They explored with a partner, sharing discoveries.",
    craft: " They learned techniques from watching others.",
  },
  opportunist: {
    forage: " They took advantage of an area others had overlooked.",
    fish: " They seized the perfect moment when the fish were biting.",
    water: " They took advantage of a recent rain to collect fresh water.",
    rest: " They grabbed rest when they saw the opportunity.",
    build: " They cleverly used materials others had discarded.",
    explore: " They ventured into areas others were too cautious to try.",
    craft: " They improvised with whatever was available.",
  },
  wildcard: {
    forage: " Their unconventional approach yielded unexpected results.",
    fish: " They tried a bizarre technique that somehow worked.",
    water: " Their unpredictable method paid off in an surprising way.",
    rest: " They dozed off in the strangest spot.",
    build: " Their chaotic building method defied all logic.",
    explore: " They wandered randomly and stumbled onto something.",
    craft: " Their wild creativity produced unusual results.",
  },
};
